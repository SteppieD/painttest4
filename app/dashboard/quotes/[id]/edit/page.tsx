      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-gray-900/80 backdrop-filter backdrop-blur-md p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-base text-gray-200 mt-1">Make changes to the quote details</p>
            </div>
            <Button
              type="button"
        ...
        <Card className="bg-gray-900/80 backdrop-filter backdrop-blur-md ">
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <Label htmlFor="customer_name" className="text-gray-100">Customer Name</Label>
                <Input
                  id="customer_name"
              ...
              <div>
                <Label htmlFor="customer_email" className="text-gray-100">Email</Label>
                <Input
                  id="customer_email"
                  type="email"
              ...
              <div>
                <Label htmlFor="customer_phone" className="text-gray-100">Phone</Label>
                <Input
                  id="customer_phone"
        ...
        <Card className="bg-gray-900/80 backdrop-filter backdrop-blur-md ">
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <Label htmlFor="project_type" className="text-gray-100">Project Type</Label>
                <Select value={quote.project_type} onValueChange={(value) => setQuote({ ...quote, project_type: value })}>
                  <SelectTrigger className="bg-gray-900/70 border-white/20 text-white">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                <Label htmlFor="paint_quality" className="text-gray-100">Paint Quality</Label>
              ...
              <div>
                <Label htmlFor="timeline" className="text-gray-100">Timeline</Label>
                <Input
                  id="timeline"
            ...
            <div>
              <Label htmlFor="special_requests" className="text-gray-100">Special Requests</Label>
              <Textarea
                id="special_requests"
        ...
        <Card className="bg-gray-900/80 backdrop-filter backdrop-blur-md ">
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-3">
              <div>
                <Label htmlFor="walls_sqft" className="text-gray-100">Walls (sq ft)</Label>
                <Input
                  id="walls_sqft"
                  type="number"
              ...
              <div>
                <Label htmlFor="ceilings_sqft" className="text-gray-100">Ceilings (sq ft)</Label>
                <Input
                  id="ceilings_sqft"
                  type="number"
              ...
              <div>
                <Label htmlFor="trim_sqft" className="text-gray-100">Trim (sq ft)</Label>
                <Input
                  id="trim_sqft"
                  type="number"
              ...
              <div>
                <Label htmlFor="doors_count" className="text-gray-100">Doors</Label>
                <Input
                  id="doors_count"
                  type="number"
              ...
              <div>
                <Label htmlFor="windows_count" className="text-gray-100">Windows</Label>
                <Input
                  id="windows_count"
                  type="number"
        ...
        <Card className="bg-gray-900/80 backdrop-filter backdrop-blur-md ">
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <Label htmlFor="markup_percentage" className="text-gray-100">Markup Percentage</Label>
                <Input
              ...
              <div>
                <Label htmlFor="paint_coverage" className="text-gray-100">Paint Coverage (sq ft/gallon)</Label>
                <Input
                  id="paint_coverage"
                  type="number"
            ...
            <div className="border-t border-white/20 pt-4 space-y-2">
              ...
              <div className="flex justify-between text-base font-medium">
                <span className="text-gray-200">Base Cost</span>
                <span className="text-white">${quote.base_cost.toFixed(2)}</span>
              </div>
              <div className="flex justify-between text-base">
                <span className="text-gray-200">Markup ({quote.markup_percentage}%)</span>
        ...
        <div className="flex gap-4 justify-end">
          <Link href={`/dashboard/quotes/${params.id}`}>
            <Button type="button" variant="outline" className="border-white/20 text-white hover:bg-gray-900/70">
              Cancel
            </Button>
          </Link>
          <Button
