      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <main>
          ...
          <section className="py-20">
            <div className="container mx-auto px-4">
              <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-12 max-w-4xl mx-auto">
                ...
                {testimonials.map((testimonial, index) => (
                  <div key={index} className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-base font-medium text-emerald-600">{testimonial.savings}</span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="space-y-8">
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">Sign Up in 30 Seconds</h3>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">Get Full Access Immediately</h3>
                      <p className="text-gray-700">
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">Decide After 14 Days</h3>
                      <p className="text-gray-700">
                ...
                {supportOptions.map((option, index) => {
                  ...
                  return (
                    <div key={index} className="bg-white rounded-lg shadow-md p-6 text-center border border-gray-200">
                      ...
                      <p className="text-gray-600 text-base mb-2">{option.description}</p>
                      <p className="text-blue-600 text-base font-medium">{option.availability}</p>
                    </div>
                  )
                })}
              </div>
