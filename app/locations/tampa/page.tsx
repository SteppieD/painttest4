...
export const metadata: Metadata = {
  ...
  description: 'AI-powered quoting software for Tampa painting contractors. Create professional quotes in 10-15 minutes instead of hours. Win more jobs in Tampa Bay. Free forever plan available.',
