...
export const metadata: Metadata = {
  ...
  description: 'AI-powered quoting software for Austin painting contractors. Create professional quotes in 10-15 minutes instead of hours. Win more jobs in the Live Music Capital. Free forever plan available.',
                ...
                <div>
                  ...
                  <div className="mt-8 grid grid-cols-3 gap-4 text-center">
                    <div>
                      ...
                      <p className="text-base text-gray-200">Austin Contractors</p>
                    </div>
                    <div>
              ...
              <div className="mt-12 grid gap-8 md:grid-cols-2">
                <div className="rounded-lg bg-muted/50 p-6">
                  ...
                  <footer className="mt-4">
                    ...
                    <p className="text-base text-gray-200">ATX Pro Painters, North Austin</p>
                  </footer>
                </div>
                ...
                <div className="rounded-lg bg-muted/50 p-6">
                  ...
                  <footer className="mt-4">
                    ...
                    <p className="text-base text-gray-200">Lone Star Painting, Cedar Park</p>
                  </footer>
                </div>
              </div>
