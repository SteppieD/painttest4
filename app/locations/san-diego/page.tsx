...
export const metadata: Metadata = {
  ...
  description: 'AI-powered quoting software for San Diego painting contractors. Create professional quotes in 10-15 minutes instead of hours. Win more jobs in Americas Finest City. Free forever plan available.',
