...
export const metadata: Metadata = {
  ...
  description: 'AI-powered quoting software for Nashville painting contractors. Create professional quotes in 10-15 minutes instead of hours. Win more jobs in Music City. Free forever plan available.',
