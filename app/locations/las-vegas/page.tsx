...
export const metadata: Metadata = {
  ...
  description: 'AI-powered quoting software for Las Vegas painting contractors. Create professional quotes in 10-15 minutes instead of hours. Win more jobs in Entertainment Capital. Free forever plan available.',
