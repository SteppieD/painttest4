...
export const metadata: Metadata = {
  ...
  description: 'AI-powered quoting software for Denver painting contractors. Create professional quotes in 10-15 minutes instead of hours. Win more jobs in the Mile High City. Free forever plan available.',
