                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-red-500/10 rounded p-4">
                          ...
                          <p className="text-base text-gray-200 mt-2">Customer anchors on low price</p>
                        </div>
                        <div className="bg-green-500/10 rounded p-4">
                          ...
                          <p className="text-base text-gray-200 mt-2">$2,600 now seems reasonable</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="bg-gray-800/30 border-gray-700 p-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="bg-gray-700/30 rounded-lg p-6 relative">
                    ...
                    <div className="text-3xl font-bold text-gray-200 mb-4">$2,000</div>
                    <ul className="space-y-2 text-gray-100 text-base">
                      <li>✓ Basic prep work</li>
                      <li>✓ Standard paint</li>
                      <li>✓ 2-year warranty</li>
                      <li className="text-gray-200">✗ Premium features</li>
                    </ul>
                    <p className="text-base text-gray-200 mt-4">20% choose this</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg p-6 relative border-2 border-purple-500/50">
                    ...
                    <p className="text-base text-purple-400 mt-4">65% choose this</p>
                  </div>
                  ...
                  <div className="bg-gray-700/30 rounded-lg p-6 relative">
                    ...
                    <p className="text-base text-gray-200 mt-4">15% choose this</p>
                  </div>
                </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="bg-gray-800/30 border-gray-700 p-6">
                  ...
                  <p className="text-gray-100 mb-4">Break down large costs into daily amounts:</p>
                ...
                <Card className="bg-gray-800/30 border-gray-700 p-6">
                  ...
                  <p className="text-gray-100 mb-4">Make individual items seem free:</p>
                  <div className="space-y-3">
                    <div className="text-base">
                      <p className="line-through text-gray-200">Power washing: $300</p>
                      <p className="line-through text-gray-200">Minor repairs: $200</p>
                      <p className="line-through text-gray-200">Premium paint: $400</p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-100">Connect personally, find common ground, establish trust before talking price.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-100">Focus on benefits and outcomes, not features. Paint a picture of the result.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-100">Start with premium option. Be confident. Silence after stating price is powerful.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-100">Prepared responses, empathy first, reframe to value, offer payment options.</p>
                    </div>
                  </div>
