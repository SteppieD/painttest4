              ...
              <div className="mt-12 grid gap-8 md:grid-cols-3">
                <div className="rounded-lg border bg-background p-6">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-sm text-muted-foreground">Chen's Quality Painting</p>
                  </div>
                </div>
                ...
                <div className="rounded-lg border bg-background p-6">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-sm text-muted-foreground">Martinez Pro Painters</p>
                  </div>
                </div>
                ...
                <div className="rounded-lg border bg-background p-6">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-sm text-muted-foreground">Thompson Painting Group</p>
                  </div>
                </div>
              </div>
            </div>
