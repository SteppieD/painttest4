            ...
            <div className="container">
              <div className="mx-auto max-w-4xl">
                <h2 className="text-center text-3xl font-bold tracking-tight sm:text-4xl">
                  Painting Quotes vs. Estimates: What&rsquo;s the Difference?
                </h2>
                ...
                <div className="mt-12 grid gap-8 md:grid-cols-2">
                  <div className="rounded-lg bg-background p-6">
                    ...
                    <p className="mt-3 text-gray-200">
                      A quote is a fixed price offer that doesn&rsquo;t change. Once accepted, you&rsquo;re 
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-gray-200">
                        ...
                        your overhead and profit margins. Be transparent about what&rsquo;s included and what 
                        would cost extra.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-gray-200">
                        ...
                        up within 3-5 days if you haven&rsquo;t heard back.
                      </p>
                    </div>
                  </div>
                </div>
